...
void xtest_isLabel_should_return_0_if_the_word_is_instruction_capital_letter() {
	String word = {.rawString = "BZ", .startIndex = 0, .length = 2};
	int result;
...
void test_isLabel_should_return_1_if_the_word_is_valid_label_capital_letter() {
	String word = {.rawString = ".BZ", .startIndex = 0, .length = 3};
	int result;
